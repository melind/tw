...
if(!subscriber) { return <Redirect to="/" />}
    ...
    return (
        ...
        <div className="info">
             < img src="../../../images/popcorn.svg" alt="image d'un pot de popcorn" />
                <h1>Votre compte</h1>
             < img src="../../../images/popcorn.svg" alt="image d'un pot de popcorn"/>
        </div>
        Pseudo: {pseudo} < br/> 
        ...
        <button onClick={handleDelete}><img src="https://media.giphy.com/media/dyJ9XHstowFRC/giphy.gif" alt="gif d'un bonhomme de lumière allant vers la sortie"/>Désinscription</button> 
